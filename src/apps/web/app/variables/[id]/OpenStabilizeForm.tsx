...
export function OpenStabilizeForm({
  ...
  async function handleSubmit(e: React.FormEvent): Promise<void> {
    ...
    const result = await openStabilizeEpisode(variableId, objective.trim());
  ...
  return (
    ...
    >
      ...
      >
        Open Stabilize Episode for {variableName}
      </div>
      ...
      <div style={{ marginBottom: "1rem" }}>
        ...
        <textarea
          ...
          placeholder="What are you trying to stabilize? (e.g., 'Restore sleep schedule to 7+ hours')"
          style={{
            width: "100%",
            minHeight: "80px",
            padding: "0.75rem",
